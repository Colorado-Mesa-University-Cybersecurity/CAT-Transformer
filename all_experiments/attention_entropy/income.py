...
'''
The entropy of averaged attention distributions for different number of layers using income dataset
'''
...
for t in range(epochs):
    ...
    test_loss, test_acc, train_f1, attn = test(regression_on=False,
                               get_attn=True,
...
attn_entropy_get(entropylog, model_cat, "CAT", 2, "Income", df_train, df_test, 'income', cat_columns, cont_columns, device_in_use)
attn_entropy_get(entropylog, model_ft, "FT", 2, "Income", df_train, df_test, 'income', cat_columns, cont_columns, device_in_use)
...
attn_entropy_get(entropylog, model_cat, "CAT", 4, "Income", df_train, df_test, 'income', cat_columns, cont_columns, device_in_use)
attn_entropy_get(entropylog, model_ft, "FT", 4, "Income", df_train, df_test, 'income', cat_columns, cont_columns, device_in_use)
...
attn_entropy_get(entropylog, model_cat, "CAT", 6, "Income", df_train, df_test, 'income', cat_columns, cont_columns, device_in_use)
attn_entropy_get(entropylog, model_ft, "FT", 6, "Income", df_train, df_test, 'income', cat_columns, cont_columns, device_in_use)
...
attn_entropy_get(entropylog, model_cat, "CAT", 7, "Income", df_train, df_test, 'income', cat_columns, cont_columns, device_in_use)
attn_entropy_get(entropylog, model_ft, "FT", 7, "Income", df_train, df_test, 'income', cat_columns, cont_columns, device_in_use)
...
attn_entropy_get(entropylog, model_cat, "CAT", 8, "Income", df_train, df_test, 'income', cat_columns, cont_columns, device_in_use)
attn_entropy_get(entropylog, model_ft, "FT", 8, "Income", df_train, df_test, 'income', cat_columns, cont_columns, device_in_use)
...
attn_entropy_get(entropylog, model_cat, "CAT", 9, "Income", df_train, df_test, 'income', cat_columns, cont_columns, device_in_use)
attn_entropy_get(entropylog, model_ft, "FT", 9, "Income", df_train, df_test, 'income', cat_columns, cont_columns, device_in_use)
...
attn_entropy_get(entropylog, model_cat, "CAT", 1, "Income", df_train, df_test, 'income', cat_columns, cont_columns, device_in_use)
attn_entropy_get(entropylog, model_ft, "FT", 1, "Income", df_train, df_test, 'income', cat_columns, cont_columns, device_in_use)
...
attn_entropy_get(entropylog, model_cat, "CAT", 3, "Income", df_train, df_test, 'income', cat_columns, cont_columns, device_in_use)
attn_entropy_get(entropylog, model_ft, "FT", 3, "Income", df_train, df_test, 'income', cat_columns, cont_columns, device_in_use)
