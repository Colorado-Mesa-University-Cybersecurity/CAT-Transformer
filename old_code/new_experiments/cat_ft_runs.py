...
'''
All CAT and FT performance trials were run from this script.
ModelPerformanceLog creates a large dictionary object that houses all training and testing data from all trials.
Data was saved as a pickle file and all data can be retrieved using to_csv.py
'''
